...
**Core Stack:** Python, R, SQL, Power BI | **Techniques:** Time-Series, GLMs, Clustering, Deep Learning
...
*Predictive forecasting models using historical market data to analyze asset price movements and assess market risk.*
...
### 🤖 Comparative Study: ARIMA vs. LSTM on Volatile Datasets
*A benchmark study evaluating traditional econometric methods against deep learning approaches for financial time-series forecasting.*
...
### 🏘️ Rental Portfolio Segmentation: A Clustering Study
...
*   **Tech Stack:** `Python` | `Gaussian Mixture Models (GMM)` | `K-Means` | `Cluster Diagnostics`
*   🔗 **[View Project Code on GitHub](#)**

### 🎬 Predictive Rating Engine & Feature Importance Analysis
*A statistical machine learning pipeline built to analyze user behavior, preference trends, and feature interactions within large-scale text and categorical datasets.*
...
---
*For a comprehensive overview of my experience, education, and certifications, please [view my CV](#).*
